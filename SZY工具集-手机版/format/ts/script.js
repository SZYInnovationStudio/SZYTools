(function () {
    ...
    bf.addEventListener('click', function () {
        ...
        try { var o = { indent_size: parseInt(iso.value), indent_char: ' ', max_preserve_newlines: 2 }; var r = (typeof js_beautify !== 'undefined') ? js_beautify(v, o) : v; out.value = r; og.style.display = 'flex'; occ.textContent = r.length + ' 字符'; }
    ...
    bd.addEventListener('click', function () { inp.value = 'type User={id:number;name:string;email?:string;roles:Array<string>;};function getUser(id:number):User{return{id,name:"test"};}'; cc.textContent = inp.value.length + ' 字符'; });
